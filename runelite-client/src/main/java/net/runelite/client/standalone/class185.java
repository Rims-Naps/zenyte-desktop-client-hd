...
@ObfuscatedName("lk")
public class class185 implements class141 {
   @ObfuscatedName("f")
   @ObfuscatedSignature(
      signature = "(I)Lls;",
      garbageValue = "1690747412"
   )
   public class175 vmethod3225() {
      byte var1;
      if(class279.field3019.startsWith("win")) {
         var1 = 1;
      } else if(class279.field3019.startsWith("mac")) {
         var1 = 2;
      } else if(class279.field3019.startsWith("linux")) {
         var1 = 3;
      } else {
         var1 = 4;
      }
      ...
      String var23 = "";
      int[] var28 = new int[3];
      return new class175(var1, var29, var7, var8, var39, var40, var10, false, var15, var16, var17, 0, var18, var19, var20, var21, 0, 0, 0, 0, var22, var23, var28, 0, "");
   }
}
