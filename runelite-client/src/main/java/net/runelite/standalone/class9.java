...
public class class9 extends class168 implements RSIgnoreContainer {
   ...
   public void method164(class125 var1, int var2) {
      while(true) {
         if(var1.field1693 < var2) {
            int var3 = var1.method2256();
            boolean var4 = (var3 & 1) == 1;
            class158 var5 = new class158(var1.method2265(), this.field92);
            class158 var6 = new class158(var1.method2265(), this.field92);
            var1.method2265();
