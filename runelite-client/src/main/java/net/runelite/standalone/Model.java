...
public class Model extends Entity implements RSModel {
   ...
   @ObfuscatedName("af")
   final void method5473(boolean var1, boolean var2, boolean var3, long var4) {
   ...
   public final void method5471(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      ...
      try {
         this.method5473(false, false, false, 0L);
   ...
   @ObfuscatedName("an")
   final void method5474(int var1) {
      if(field1678[var1]) {
         this.method5475(var1);
      } else {
         ...
         if(this.field1644 != null && this.field1644[var1] != -1) {
            ...
            if(this.field1668[var1] == -1) {
               Graphics3D.method2575(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1650[var1], this.field1650[var1], this.field1650[var1], yViewportBuffer[var5], yViewportBuffer[var6], yViewportBuffer[var7], field1683[var5], field1683[var6], field1683[var7], field1672[var5], field1672[var6], field1672[var7], this.field1644[var1]);
            } else {
               Graphics3D.method2575(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1650[var1], this.field1706[var1], this.field1668[var1], yViewportBuffer[var5], yViewportBuffer[var6], yViewportBuffer[var7], field1683[var5], field1683[var6], field1683[var7], field1672[var5], field1672[var6], field1672[var7], this.field1644[var1]);
            }
         } else if(this.field1668[var1] == -1) {
            Graphics3D.method2573(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], field1704[this.field1650[var1]]);
         } else {
            Graphics3D.method2571(modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4], this.field1650[var1], this.field1706[var1], this.field1668[var1]);
         }
   ...
   @ObfuscatedName("ax")
   final void method5475(int var1) {
      ...
      if(var4 == 3) {
         ...
         if(this.field1644 != null && this.field1644[var1] != -1) {
            ...
            if(this.field1668[var1] == -1) {
               Graphics3D.method2575(var14, var15, var16, var11, var12, var13, this.field1650[var1], this.field1650[var1], this.field1650[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1683[var17], field1683[var18], field1683[var19], field1672[var17], field1672[var18], field1672[var19], this.field1644[var1]);
            } else {
               Graphics3D.method2575(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1683[var17], field1683[var18], field1683[var19], field1672[var17], field1672[var18], field1672[var19], this.field1644[var1]);
            }
         } else if(this.field1668[var1] == -1) {
            Graphics3D.method2573(var14, var15, var16, var11, var12, var13, field1704[this.field1650[var1]]);
         } else {
            Graphics3D.method2571(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2]);
         }
      }
      ...
      if(var4 == 4) {
         ...
         if(this.field1644 != null && this.field1644[var1] != -1) {
            ...
            if(this.field1668[var1] == -1) {
               Graphics3D.method2575(var14, var15, var16, var11, var12, var13, this.field1650[var1], this.field1650[var1], this.field1650[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1683[var17], field1683[var18], field1683[var19], field1672[var17], field1672[var18], field1672[var19], var21);
               Graphics3D.method2575(var14, var16, field1698[3], var11, var13, field1693[3], this.field1650[var1], this.field1650[var1], this.field1650[var1], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1683[var17], field1683[var18], field1683[var19], field1672[var17], field1672[var18], field1672[var19], var21);
            } else {
               Graphics3D.method2575(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1683[var17], field1683[var18], field1683[var19], field1672[var17], field1672[var18], field1672[var19], var21);
               Graphics3D.method2575(var14, var16, field1698[3], var11, var13, field1693[3], xViewportBuffer[0], xViewportBuffer[2], xViewportBuffer[3], yViewportBuffer[var17], yViewportBuffer[var18], yViewportBuffer[var19], field1683[var17], field1683[var18], field1683[var19], field1672[var17], field1672[var18], field1672[var19], var21);
            }
         } else if(this.field1668[var1] == -1) {
            var17 = field1704[this.field1650[var1]];
            Graphics3D.method2573(var14, var15, var16, var11, var12, var13, var17);
            Graphics3D.method2573(var14, var16, field1698[3], var11, var13, field1693[3], var17);
         } else {
            Graphics3D.method2571(var14, var15, var16, var11, var12, var13, xViewportBuffer[0], xViewportBuffer[1], xViewportBuffer[2]);
            Graphics3D.method2571(var14, var16, field1698[3], var11, var13, field1693[3], xViewportBuffer[0], xViewportBuffer[2], xViewportBuffer[3]);
         }
      }
            ...
            if(var17 / var14 > Graphics3D.Rasterizer3D_clipNegativeMidX) {
               ...
               if(var20 / var14 > Graphics3D.Rasterizer3D_clipNegativeMidY) {
                  ...
                  if(var22 / var14 < Graphics3D.Rasterizer3D_clipMidY2) {
                     ...
                     try {
                        this.method5473(var24, var33, this.field1664, var9);
