...
public class class104 extends class324 {
   ...
   public static Js5Index field1156;
   @ObfuscatedName("s")
   @ObfuscatedGetter(
      intValue = -1449440461
   )
   ...
   void method1859(Buffer var1, int var2) {
      if(var2 == 1) {
         this.field1153 = class274.method5367(var1.method2257());
      } else if(var2 == 2) {
         this.field1154 = var1.readInt();
      } else if(var2 == 4) {
         this.field1152 = false;
      } else if(var2 == 5) {
         this.field1155 = var1.readString();
      }
