...
public class class106 extends CacheableNode implements RSScript {
   ...
   public static Enum method1885(int var0) {
      ...
      if(var1 != null) {
         ...
         var1 = new Enum();
         if(var2 != null) {
            var1.method6509(new Buffer(var2));
         }
   ...
   static void method1882(Buffer var0, int var1) {
   ...
   static boolean method1881(Bit var0, int var1) {
      ...
      if(var2 == 0) {
         ...
         var3 = var0.method2833(13);
         var4 = var0.method2833(13);
         boolean var12 = var0.method2833(1) == 1;
         if(var12) {
