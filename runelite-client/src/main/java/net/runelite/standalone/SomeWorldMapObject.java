...
@ObfuscatedName("k")
public class SomeWorldMapObject {
   @ObfuscatedName("p")
   @ObfuscatedSignature(
      signature = "Lgq;"
   )
   ...
   SomeWorldMapObject(int var1, int var2, int var3, HashMap var4) {
      this.field529 = var1;
      this.field532 = var2;
   ...
   int method909(int var1, int var2, WorldMapNode var3, class230 var4) {
   ...
   class123 getMapIcon(int var1) {
      ObjectDef var2 = class285.getObjectDef(var1);
      ...
      return var2.mapIconDef != -1?class133.method2550(var2.mapIconDef):null;
   }
   ...
   class230 method904(int var1, int var2, SomeWorldMapObject[] var3) {
   ...
   void method908(int var1, int var2, int var3, int var4, int var5, int var6, SomeWorldMapObject var7, class229 var8) {
   ...
   class107 method925(class123 var1) {
      if(var1.text != null && this.field537 != null && this.field537.get(class181.field2480) != null) {
         ...
         if(var2 == null) {
            ...
            if(var14 == null) {
               ...
               var6 = var14.method3812(var1.text, 1000000);
               String[] var15 = new String[var6];
               var14.method3810(var1.text, (int[])null, var15);
               ...
               return new class107(var1.text, var9, var8, var2);
            }
         }
      } else {
         return null;
   ...
   void method890() {
      if(this.field531 != null) {
         ...
         while(var5.hasNext()) {
            WorldMapChunk var6 = (WorldMapChunk)var5.next();
   ...
   void method893(HashSet var1, List var2) {
      ...
      while(var3.hasNext()) {
         WorldMapChunk var4 = (WorldMapChunk)var3.next();
   ...
   void method920(int var1, int var2, WorldMapNode var3) {
      field538.method1263(0, var1, var2);

      for(int var4 = 0; var4 < var3.field2139; ++var4) {
         WorldMapGameObject[] var5 = var3.objects[var4][var1][var2];
         if(var5 != null && var5.length != 0) {
            WorldMapGameObject[] var6 = var5;

            for(int var7 = 0; var7 < var6.length; ++var7) {
               WorldMapGameObject var8 = var6[var7];
               class123 var9 = this.getMapIcon(var8.objectId);
               if(var9 != null) {
                  MapIcon var10 = (MapIcon)this.field533.get(field538);
                  if(var10 != null) {
                     if(var9.field1682 != var10.field258) {
                        MapIcon var16 = new MapIcon(var9.field1682, var10.field248, var10.field259, this.method925(var9));
                  ...
                  if(this.field531 != null) {
                     ...
                     while(var13.hasNext()) {
                        WorldMapChunk var14 = (WorldMapChunk)var13.next();
                  ...
                  if(var12 != null) {
                     var10 = new MapIcon(var9.field1682, var12, var11, this.method925(var9));
   ...
   void method903(int var1, int var2, WorldMapNode var3, class210 var4) {
      for(int var5 = 1; var5 < var3.field2139; ++var5) {
         int var6 = var3.field2141[var5][var1][var2] - 1;
         if(var6 > -1) {
            int var7 = WorldMapChunk.method1919(var6, this.field539);
            if(var3.field2142[var5][var1][var2] == 0) {
               Rasterizer2D.method3167(this.field534 * var1, this.field534 * (63 - var2), this.field534, this.field534, var7);
            } else {
   ...
   void method915(MapIcon var1, int var2, int var3, float var4) {
   ...
   void method892(WorldMapRegion var1, List var2) {
      this.field533.clear();
      this.field531 = var1;
   ...
   void method914(class123 var1, int var2, int var3, int var4, int var5) {
      ...
      if(var6 != null) {
         ...
         if(var4 % var5 < var5 / 2) {
            Rasterizer2D.method3144(var2, var3, 15, 16776960, 128);
            Rasterizer2D.method3144(var2, var3, 7, 16777215, 256);
         }
   ...
   void method894(int var1, int var2, int var3, int var4, WorldMapNode var5) {
      for(int var6 = var1; var6 < var3 + var1; ++var6) {
         ...
         for(int var7 = var2; var7 < var2 + var4; ++var7) {
            ...
            for(int var9 = 0; var9 < var5.field2139; ++var9) {
               WorldMapGameObject[] var10 = var5.objects[var9][var6][var7];
               if(var10 != null && var10.length != 0) {
                  WorldMapGameObject[] var11 = var10;

                  for(int var12 = 0; var12 < var11.length; ++var12) {
                     WorldMapGameObject var13 = var11[var12];
                     class123 var14 = this.getMapIcon(var13.objectId);
                     if(var14 != null) {
                        ...
                        if(this.field531 != null) {
                           ...
                           WorldMapChunk var17 = (WorldMapChunk)var5;
                        ...
                        MapIcon var18 = new MapIcon(var14.field1682, var16, var15, this.method925(var14));
   ...
   void method958(int var1, int var2, WorldMapNode var3, class210 var4, class303[] var5) {
   ...
   void method895(List var1) {
      ...
      while(var2.hasNext()) {
         ...
         if(var3.field2509.field719 >> 6 == this.field529 && var3.field2509.field717 >> 6 == this.field532) {
            MapIcon var4 = new MapIcon(var3.field2508, var3.field2509, var3.field2509, this.method924(var3.field2508));
   ...
   void method944(SomeWorldMapObject[] var1, class229 var2) {
   ...
   void method899(class210 var1, SomeWorldMapObject[] var2, class303[] var3, class230 var4) {
      int var5;
      int var6;
   ...
   void method907(int var1, int var2, int var3, int var4, WorldMapNode var5, class229 var6) {
   ...
   void method1035(int var1, int var2, WorldMapNode var3) {
      for(int var4 = 0; var4 < var3.field2139; ++var4) {
         WorldMapGameObject[] var5 = var3.objects[var4][var1][var2];
         if(var5 != null && var5.length != 0) {
            WorldMapGameObject[] var6 = var5;
            ...
            for(int var7 = 0; var7 < var6.length; ++var7) {
               ...
               if(class275.method5369(var8.field1708)) {
                  ObjectDef var9 = class285.getObjectDef(var8.objectId);
                  ...
                  if(var8.field1708 == class264.field3422.field3433) {
                     if(var8.field1710 == 0) {
                        Rasterizer2D.method3213(this.field534 * var1, this.field534 * (63 - var2), 1, var10);
                     }

                     if(var8.field1710 == 1) {
                        Rasterizer2D.method3213(this.field534 * var1 + this.field534 - 1, this.field534 * (63 - var2), 1, var10);
                     }

                     if(var8.field1710 == 2) {
                        Rasterizer2D.method3213(this.field534 + this.field534 * var1 - 1, this.field534 * (63 - var2) + this.field534 - 1, 1, var10);
                     }

                     if(var8.field1710 == 3) {
                        Rasterizer2D.method3213(this.field534 * var1, this.field534 * (63 - var2) + this.field534 - 1, 1, var10);
                     }
                  }
                  ...
                  if(var8.field1708 == class264.field3432.field3433) {
                     ...
                     if(var11 == 0) {
                        for(var12 = 0; var12 < this.field534; ++var12) {
                           Rasterizer2D.method3213(var12 + this.field534 * var1, (64 - var2) * this.field534 - 1 - var12, 1, var10);
                        }
                     } else {
                        for(var12 = 0; var12 < this.field534; ++var12) {
                           Rasterizer2D.method3213(var12 + this.field534 * var1, var12 + this.field534 * (63 - var2), 1, var10);
                        }
                     }
                  }
               }
   ...
   void method1004(int var1, class210 var2, SomeWorldMapObject[] var3, class303[] var4) {
      this.field534 = var1;
   ...
   void method911(int var1, int var2, WorldMapNode var3, class210 var4, class230 var5) {
      int var6 = var3.field2140[0][var1][var2] - 1;
      int var7 = var3.field2141[0][var1][var2] - 1;
      if(var6 == -1 && var7 == -1) {
         Rasterizer2D.method3167(this.field534 * var1, this.field534 * (63 - var2), this.field534, this.field534, this.field539);
      }

      int var8 = 16711935;
      if(var7 != -1) {
         var8 = WorldMapChunk.method1919(var7, this.field539);
      }

      if(var7 > -1 && var3.field2142[0][var1][var2] == 0) {
         Rasterizer2D.method3167(this.field534 * var1, this.field534 * (63 - var2), this.field534, this.field534, var8);
      } else {
         int var9 = this.method909(var1, var2, var3, var5);
         if(var7 == -1) {
            Rasterizer2D.method3167(this.field534 * var1, this.field534 * (63 - var2), this.field534, this.field534, var9);
         } else {
   ...
   class230 method902(SomeWorldMapObject[] var1) {
   ...
   void method917(MapIcon var1, class123 var2, int var3, int var4, float var5) {
   ...
   void method928(int var1, int var2, int var3, int var4) {
      var3 %= 4;
      if(var3 == 0) {
         Rasterizer2D.method3206(this.field534 * var1, this.field534 * (63 - var2), this.field534, var4);
      }

      if(var3 == 1) {
         Rasterizer2D.method3213(this.field534 * var1, this.field534 * (63 - var2), this.field534, var4);
      }

      if(var3 == 2) {
         Rasterizer2D.method3206(this.field534 + this.field534 * var1 - 1, this.field534 * (63 - var2), this.field534, var4);
      }

      if(var3 == 3) {
         Rasterizer2D.method3213(this.field534 * var1, this.field534 * (63 - var2) + this.field534 - 1, this.field534, var4);
      }
   ...
   void method910(int var1, int var2, WorldMapNode var3, class303[] var4) {
      for(int var5 = 0; var5 < var3.field2139; ++var5) {
         WorldMapGameObject[] var6 = var3.objects[var5][var1][var2];
         if(var6 != null && var6.length != 0) {
            WorldMapGameObject[] var7 = var6;

            for(int var8 = 0; var8 < var7.length; ++var8) {
               WorldMapGameObject var9 = var7[var8];
               if(class233.method4653(var9.field1708) || class184.method3710(var9.field1708)) {
                  ObjectDef var10 = class285.getObjectDef(var9.objectId);
                  if(var10.field158 != -1) {
