...
public class class115 extends class310 {
   ...
   void method1990(Buffer var1, Buffer var2) {
   ...
   static final void method1983(int var0, int var1, int var2, int var3) {
      ...
      if(!client.field889) {
         ...
         if(GameEngine.options.hideRoofs) {
            ...
            if(var6 - Buffer.cameraZ < 800 && (class98.tileSettings[class228.level][class166.cameraX >> 7][class98.cameraY >> 7] & 4) != 0) {
               var29 = class228.level;
            } else {
               var29 = 3;
            }
      ...
      class131.sceneManager.method3836(class166.cameraX, Buffer.cameraZ, class98.cameraY, ScriptEvent.cameraPitch, class39.cameraYaw, var4);
