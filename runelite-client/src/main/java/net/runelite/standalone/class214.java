...
@ObfuscatedName("d")
public class class214 extends class175 {
   @ObfuscatedName("kp")
   @ObfuscatedGetter(
      intValue = -1215790901
   )
   ...
   static final void method4369(String var0, boolean var1) {
      if(client.field2268) {
         ...
         class173.method3167(var3 - var2, var4 - var2, var5 + var2 + var2, var6 + var2 + var2, 0);
         class173.method3149(var3 - var2, var4 - var2, var5 + var2 + var2, var6 + var2 + var2, 16777215);
