...
@ObfuscatedName("dx")
public final class class110 extends class197 implements RSTile {
   public static RSDeque[][][] lastGroundItems;
   public static GameObject lastGameObject;
   @ObfuscatedName("aj")
   static String field1218;
   @ObfuscatedName("j")
   boolean field1210;
   @ObfuscatedName("z")
   @ObfuscatedSignature(
   ...
   class110(int var1, int var2, int var3) {
      this.field1217 = new class195[5];
      this.gameObjectsChanged(-1);
      this.field1195 = new int[5];
      this.field1196 = 0;
      this.field1198 = this.field1214 = var1;
      this.field1204 = var2;
      this.field1197 = var3;
   }
   ...
   public void itemLayerChanged(int var1) {
      int var2 = this.getX();
      int var3 = this.getY();
      int var4 = class302.field3755.getPlane();
      RSDeque[][][] var5 = class302.field3755.getGroundItemDeque();
      ...
      if(var6 != var7) {
         if(var6 != null) {
            ...
            for(RSNode var9 = var8.getNext(); var9 != var8; var9 = var9.getNext()) {
               ...
               class302.field3755.getCallbacks().post(var11);
            }
         }
      ...
      RSItem var18 = class302.field3755.getLastItemDespawn();
      if(var18 != null) {
         class302.field3755.setLastItemDespawn((RSItem)null);
      }
      ...
      if(var19 == null) {
         if(var18 != null) {
            ...
            class302.field3755.getCallbacks().post(var20);
         }
         ...
         if(var18 != null && var18 != var13 && var18 != var22) {
            ...
            class302.field3755.getCallbacks().post(var23);
         }
         ...
         if(var12 != null) {
            do {
               ...
               class302.field3755.getCallbacks().post(var17);
   ...
   public WorldPoint getWorldLocation() {
      return WorldPoint.fromScene(class302.field3755, this.getX(), this.getY(), this.getPlane());
   }
   ...
   public boolean hasLineOfSightTo(Tile var1) {
      if(this.getPlane() != var1.getPlane()) {
         ...
         RSCollisionData[] var2 = class302.field3755.getCollisionMaps();
   ...
   static void method1923(String var0, boolean var1) {
      var0 = var0.toLowerCase();
      short[] var2 = new short[16];
      int var3 = 0;

      for(int var4 = 0; var4 < class42.field425; ++var4) {
         class42 var5 = class164.method3014(var4);
         if((!var1 || var5.field471) && var5.field456 == -1 && var5.field446.toLowerCase().indexOf(var0) != -1) {
            if(var3 >= 250) {
               class94.field1020 = -1;
               class109.field1193 = null;
               return;
            }
      ...
      class109.field1193 = var2;
      class322.field3938 = 0;
      class94.field1020 = var3;
      String[] var8 = new String[class94.field1020];

      for(int var9 = 0; var9 < class94.field1020; ++var9) {
         var8[var9] = class164.method3014(var2[var9]).field446;
      }

      class129.method2493(var8, class109.field1193);
   }
}
