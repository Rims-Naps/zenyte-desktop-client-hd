...
public class class240 extends class197 {
   ...
   class240(class125 var1) {
      ...
      for(int var60 = 0; var60 < var2; ++var60) {
         ...
         while(true) {
            while(true) {
               int var63 = var1.method2263();
               var51.method2318(var63);
               int var64 = var1.field1694[var29++] & 255;
               boolean var65 = var64 != var62;
               var62 = var64 & 15;
               if(var64 == 7) {
                  if(var65) {
                     var51.method2288(255);
                  }
               ...
               if(var64 == 23) {
                  ...
                  var51.method2288(81);
                  var51.method2288(3);
                  var51.method2288(var1.field1694[var50++]);
                  var51.method2288(var1.field1694[var50++]);
                  var51.method2288(var1.field1694[var50++]);
               } else {
                  var52 ^= var64 >> 4;
                  if(var62 == 0) {
                     if(var65) {
                        var51.method2288(var52 + 144);
                     }

                     var53 += var1.field1694[var37++];
                     var54 += var1.field1694[var38++];
                     var51.method2288(var53 & 127);
                     var51.method2288(var54 & 127);
                  } else if(var62 == 1) {
                     if(var65) {
                        var51.method2288(var52 + 128);
                     }

                     var53 += var1.field1694[var37++];
                     var55 += var1.field1694[var40++];
                     var51.method2288(var53 & 127);
                     var51.method2288(var55 & 127);
                  } else if(var62 == 2) {
                     if(var65) {
                        var51.method2288(var52 + 176);
                     }

                     var28 = var28 + var1.field1694[var15++] & 127;
                     var51.method2288(var28);
                     byte var66;
                     if(var28 != 0 && var28 != 32) {
                        if(var28 == 1) {
                           var66 = var1.field1694[var34++];
                        } else if(var28 == 33) {
                           var66 = var1.field1694[var41++];
                        } else if(var28 == 7) {
                           var66 = var1.field1694[var35++];
                        } else if(var28 == 39) {
                           var66 = var1.field1694[var42++];
                        } else if(var28 == 10) {
                           var66 = var1.field1694[var36++];
                        } else if(var28 == 42) {
                           var66 = var1.field1694[var43++];
                        } else if(var28 == 99) {
                           var66 = var1.field1694[var46++];
                        } else if(var28 == 98) {
                           var66 = var1.field1694[var47++];
                        } else if(var28 == 101) {
                           var66 = var1.field1694[var48++];
                        } else if(var28 == 100) {
                           var66 = var1.field1694[var49++];
                        } else if(var28 != 64 && var28 != 65 && var28 != 120 && var28 != 121 && var28 != 123) {
                           var66 = var1.field1694[var39++];
                        } else {
                           var66 = var1.field1694[var30++];
                        }
                     } else {
                        var66 = var1.field1694[var44++];
                     }

                     int var67 = var66 + var59[var28];
                     var59[var28] = var67;
                     var51.method2288(var67 & 127);
                  } else if(var62 == 3) {
                     if(var65) {
                        var51.method2288(var52 + 224);
                     }

                     var56 += var1.field1694[var45++];
                     var56 += var1.field1694[var33++] << 7;
                     var51.method2288(var56 & 127);
                     var51.method2288(var56 >> 7 & 127);
                  } else if(var62 == 4) {
                     if(var65) {
                        var51.method2288(var52 + 208);
                     }

                     var57 += var1.field1694[var32++];
                     var51.method2288(var57 & 127);
                  } else if(var62 == 5) {
                     if(var65) {
                        var51.method2288(var52 + 160);
                     }

                     var53 += var1.field1694[var37++];
                     var58 += var1.field1694[var31++];
                     var51.method2288(var53 & 127);
                     var51.method2288(var58 & 127);
                  } else {
                     if(var62 != 6) {
                        throw new RuntimeException();
                     }
                     ...
                     if(var65) {
                        var51.method2288(var52 + 192);
                     }

                     var51.method2288(var1.field1694[var44++]);
                  }
               }
            }
         }
   ...
   void method4728() {
      if(this.field3142 == null) {
         this.field3142 = new class98(16);
         int[] var1 = new int[16];
         int[] var2 = new int[16];
         var2[9] = 128;
         var1[9] = 128;
         class51 var4 = new class51(this.field3143);
         int var5 = var4.method1109();

         int var6;
         for(var6 = 0; var6 < var5; ++var6) {
            var4.method1088(var6);
            var4.method1082(var6);
            var4.method1080(var6);
         }

         label53:
         do {
            while(true) {
               var6 = var4.method1087();
               int var7 = var4.field570[var6];

               while(var7 == var4.field570[var6]) {
                  var4.method1088(var6);
                  int var8 = var4.method1083(var6);
                  if(var8 == 1) {
                     var4.method1073();
                     var4.method1080(var6);
                     continue label53;
                  ...
                  if(var9 == 144) {
                     ...
                     if(var12 > 0) {
                        ...
                        class237 var14 = (class237)this.field3142.method1776((long)var13);
                        if(var14 == null) {
                           var14 = new class237(new byte[128]);
                           this.field3142.method1775(var14, (long)var13);
                        }

                        var14.field3120[var11] = 1;
                     }
                  }
