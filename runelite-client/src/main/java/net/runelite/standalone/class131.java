...
public class class131 extends WorldMapData {
        ...
        while (var18 < 4) {
            ...
            if (class305.field3772.exists()) {
                try {
                    ...
                    Buffer var11;
                    int var12;
                    for (var11 = new Buffer((int) var10.method5445()); var11.position < var11.field1694.length; var11.position += var12) {
                        var12 = var10.method5446(var11.field1694, var11.position, var11.field1694.length - var11.position);
                        if (var12 == -1) {
    ...
    void decodeAll(Buffer detailsBuffer, Buffer areaBuffer, Buffer compositeMapBuffer, int var4, boolean var5) {
        this.decodeDetails(detailsBuffer, var4);
        int var6 = compositeMapBuffer.readUnsignedShort();
        this.regions = new HashSet(var6);
        ...
        for (var7 = 0; var7 < var6; ++var7) {
            ...
            try {
                region.decode(areaBuffer, compositeMapBuffer);//worldmapregion
        ...
        var7 = compositeMapBuffer.readUnsignedShort();
        this.chunks = new HashSet(var7);

        for (int var11 = 0; var11 < var7; ++var11) {
            WorldMapChunk chunk = new WorldMapChunk();

            try {
                chunk.decode(areaBuffer, compositeMapBuffer);//worldmapchunk
        ...
        this.method2512(areaBuffer, var5);
    }
