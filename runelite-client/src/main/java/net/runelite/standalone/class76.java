...
public class class76 {
   ...
   static final void method1145(ZoneProt var0) {
      ...
      if(ZoneProt.field2319 == var0) {
         ...
         int var31;
         if(ZoneProt.field2322 == var0) {
            var2 = var1.method6200();
            var3 = var2 >> 2;
            var4 = var2 & 3;
            var5 = client.field704[var3];
            var6 = var1.method6200();
         ...
         } else if(ZoneProt.field2323 == var0) {
            var2 = var1.method6116();
            var3 = var1.method6101();
            var4 = var1.method6116();
            var5 = var1.method6192();
            var6 = (var5 >> 4 & 7) + class91.updateZoneX;
            var7 = (var5 & 7) + CombatInfoListHolder.updateZoneY;
            if(var6 >= 0 && var7 >= 0 && var6 < 104 && var7 < 104) {
            ...
            if(ZoneProt.field2325 == var0) {
               ...
               int var10;
               if(ZoneProt.field2321 == var0) {
                  var2 = var1.readUnsignedByte();
                  var3 = (var2 >> 4 & 7) + class91.updateZoneX;
                  var4 = (var2 & 7) + CombatInfoListHolder.updateZoneY;
                  var5 = var1.method6200();
                  var6 = var1.method6192();
                  var7 = var6 >> 4 & 15;
                  var31 = var6 & 7;
                  var32 = var1.method6101();
                  if(var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
                     var10 = var7 + 1;
               ...
               if(ZoneProt.field2320 == var0) {
                  ...
                  if(ZoneProt.field2316 == var0) {
                     ...
                     var31 = var1.method6200();
                     var32 = var1.method6116();
                     var10 = var1.method6192();
                     var40 = (var10 >> 4 & 7) + class91.updateZoneX;
                     var12 = (var10 & 7) + CombatInfoListHolder.updateZoneY;
                     var13 = var1.method6277();
                     ...
                     Item var35;
                     if(ZoneProt.field2317 == var0) {
                        var2 = var1.method6192();
                        var3 = (var2 >> 4 & 7) + class91.updateZoneX;
                        var4 = (var2 & 7) + CombatInfoListHolder.updateZoneY;
                        var5 = var1.method6101();
                        if(var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104) {
                        ...
                        if(ZoneProt.field2318 == var0) {
                           ...
                           byte var11 = var1.method6277();
                           var12 = var1.method6116();
                           var13 = var1.method6111();
                           var14 = var1.method6108();
