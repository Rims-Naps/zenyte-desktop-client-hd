...
public class class211 extends Rasterizer2D {
   ...
   public static class8 field2895;
   @ObfuscatedName("n")
   static int field2913;
   @ObfuscatedName("l")
   static boolean field2896;
   @ObfuscatedName("s")
   public static boolean field2898;
   @ObfuscatedName("f")
   static boolean field2909;
   @ObfuscatedName("h")
   ...
   static {
      ...
      field2899 = 0;
      field2906 = 512;
      field2919 = new int[1024];
      field2916 = new int[65536];
      field2918 = new int[512];
      field2905 = new int[2048];
      field2920 = new int[2048];
      field2914 = new int[2048];

      int var0;
      for(var0 = 1; var0 < 512; ++var0) {
         field2918[var0] = 32768 / var0;
      }

      for(var0 = 1; var0 < 2048; ++var0) {
         field2905[var0] = 65536 / var0;
      }

      for(var0 = 0; var0 < 2048; ++var0) {
         field2920[var0] = (int)(65536.0D * Math.sin((double)var0 * 0.0030679615D));
         field2914[var0] = (int)(65536.0D * Math.cos((double)var0 * 0.0030679615D));
      }

   }

   @ObfuscatedName("af")
   static final int method4269(int var0, int var1, int var2, int var3) {
   ...
   @ObfuscatedName("ag")
   static final int method4312(int var0, int var1, int var2, int var3) {
      return var3 * var0 + var2 * var1 >> 16;
   }

   @ObfuscatedName("z")
   static final void method4272(int[] var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if(field2909) {
         if(var5 > field2908) {
            var5 = field2908;
         }
      ...
      if(var4 < var5) {
         ...
         if(field2898) {
            ...
            if(field2899 == 0) {
               if(var3 > 0) {
                  do {
                     var2 = var11 = field2916[var6 >> 8];
                     var6 += var7;
                     client.drawAlpha(var0, var1++, var2, var11, 255 - field2899);
                     client.drawAlpha(var0, var1++, var2, var11, 255 - field2899);
                     client.drawAlpha(var0, var1++, var2, var11, 255 - field2899);
                     client.drawAlpha(var0, var1++, var2, var11, 255 - field2899);
                     --var3;
               ...
               if(var3 > 0) {
                  do {
                     ...
                     var10 = var0[var1];
                     client.drawAlpha(var0, var1++, ((var10 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var10 & 65280) >> 8 & 65280), var11, 255 - field2899);
                     var10 = var0[var1];
                     client.drawAlpha(var0, var1++, ((var10 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var10 & 65280) >> 8 & 65280), var11, 255 - field2899);
                     var10 = var0[var1];
                     client.drawAlpha(var0, var1++, ((var10 & 16711935) * var8 >> 8 & 16711935) + var2 + (var8 * (var10 & 65280) >> 8 & 65280), var11, 255 - field2899);
            ...
            if(field2899 == 0) {
               do {
                  client.drawAlpha(var0, var1++, var11 = field2916[var6 >> 8], var11, 255 - field2899);
                  var6 += var7;
                  --var3;
               } while(var3 > 0);
            } else {
   ...
   @ObfuscatedName("p")
   static final void method4290(double var0, int var2, int var3) {
      int var4 = var2 * 128;
      ...
      for(int var5 = var2; var5 < var3; ++var5) {
         ...
         for(int var10 = 0; var10 < 128; ++var10) {
            ...
            var22 = method4254(var22, var0);
            if(var22 == 0) {
               var22 = 1;
            }

            field2916[var4++] = var22;
         }
      }
   ...
   @ObfuscatedName("i")
   static final void method4263(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14) {
      if(field2909) {
         if(var6 > field2908) {
            var6 = field2908;
         }
   ...
   @ObfuscatedName("c")
   public static final void method4252(double var0) {
      method4290(var0, 0, 512);
   }

   @ObfuscatedName("l")
   static final void method4248(int var0, int var1, int var2, int var3) {
      field2908 = var2 - var0;
      field2910 = var3 - var1;
      method4326();
      int var4;
      int var5;
      if(field2919.length < field2910) {
         var5 = field2910;
         --var5;
         var5 |= var5 >>> 1;
         var5 |= var5 >>> 2;
   ...
   public static final void method4250(int var0, int var1) {
      ...
      field2897 = var1 - var3;
      field2915 = -field2907;
      field2912 = field2908 - field2907;
      field2911 = -field2897;
      field2913 = field2910 - field2897;
   }
   ...
   @ObfuscatedName("r")
   static int method4254(int var0, double var1) {
   ...
   @ObfuscatedName("u")
   static final void method4261(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14) {
      if(field2909) {
         if(var6 > field2908) {
            var6 = field2908;
         }
   ...
   @ObfuscatedName("m")
   public static void method4262(int var0, int var1, int var2) {
      field2909 = var0 < 0 || var0 > field2908 || var1 < 0 || var1 > field2908 || var2 < 0 || var2 > field2908;
   }

   @ObfuscatedName("y")
   static final int method4266(int var0, int var1, int var2, int var3) {
      return var2 * var1 - var3 * var0 >> 16;
   }

   @ObfuscatedName("x")
   public static final void method4325(int var0, int var1, int var2, int var3, int var4, int var5, int var6) {
      int var7 = 0;
      if(var0 != var1) {
   ...
   @ObfuscatedName("v")
   static final void method4259(int[] var0, int var1, int var2, int var3, int var4, int var5) {
      int var9 = var2;
      if(field2909) {
         if(var5 > field2908) {
            var5 = field2908;
               ...
               while(true) {
                  ...
                  if(var3 < 0) {
                     ...
                     while(true) {
                        ...
                        client.drawAlpha(var0, var1++, var0[var1], var9, 255 - field2899);
                     }
                  }
               ...
               while(true) {
                  ...
                  if(var3 < 0) {
                     ...
                     while(true) {
                        ...
                        var8 = var0[var1];
                        client.drawAlpha(var0, var1++, ((var8 & 16711935) * var6 >> 8 & 16711935) + var2 + (var6 * (var8 & 65280) >> 8 & 65280), var9, 255 - field2899);
                     }
                  }
            ...
            while(true) {
               ...
               if(var3 < 0) {
                  ...
                  while(true) {
                     ...
                     client.drawAlpha(var0, var1++, var2, var9, 255 - field2899);
                  }
               }
   ...
   @ObfuscatedName("av")
   static final int method4268(int var0, int var1, int var2, int var3) {
      return var0 * var2 - var3 * var1 >> 16;
   }

   @ObfuscatedName("d")
   static final void method4256(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      int var9 = var4 - var3;
      int var10 = var1 - var0;
      int var11 = var5 - var3;
      int var12 = var2 - var0;
   ...
   @ObfuscatedName("o")
   static final void method4319(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
      int[] var19 = field2895.vmethod5291(var18);
      int var20;
      if(var19 == null) {
         var20 = field2895.vmethod5292(var18);
         method4256(var0, var1, var2, var3, var4, var5, method4255(var20, var6), method4255(var20, var7), method4255(var20, var8));
      } else {
         field2917 = field2895.vmethod5294(var18);
         field2896 = field2895.vmethod5293(var18);
         var20 = var4 - var3;
         int var21 = var1 - var0;
         int var22 = var5 - var3;
         int var23 = var2 - var0;
         ...
         if(var29 != 0) {
            ...
            int var33 = (int)(((long)(var15 * var14 - var17 * var12) << 14) / (long)field2906);
            int var34 = (int)(((long)(var17 * var9 - var11 * var15) << 14) / (long)field2906);
            int var35 = var10 * var12 - var13 * var9 << 14;
            int var36 = (int)(((long)(var13 * var15 - var16 * var12) << 14) / (long)field2906);
            int var37 = (int)(((long)(var16 * var9 - var10 * var15) << 14) / (long)field2906);
            int var38 = var13 * var11 - var10 * var14 << 14;
            int var39 = (int)(((long)(var16 * var14 - var13 * var17) << 14) / (long)field2906);
            int var40 = (int)(((long)(var17 * var10 - var11 * var16) << 14) / (long)field2906);
            int var41;
            if(var0 <= var1 && var0 <= var2) {
               if(var0 < field2910) {
                  if(var1 > field2910) {
   ...
   @ObfuscatedName("g")
   static final void method4260(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
      int[] var19 = field2895.vmethod5291(var18);
      int var20;
      if(var19 == null) {
         var20 = field2895.vmethod5292(var18);
         ...
         if(var29 != 0) {
            ...
            var17 -= var15;
            int var32 = var11 * var12 - var9 * var14 << 14;
            int var33 = (int)(((long)(var15 * var14 - var17 * var12) << 3 << 14) / (long)field2906);
            int var34 = (int)(((long)(var17 * var9 - var11 * var15) << 14) / (long)field2906);
            int var35 = var10 * var12 - var13 * var9 << 14;
            int var36 = (int)(((long)(var13 * var15 - var16 * var12) << 3 << 14) / (long)field2906);
            int var37 = (int)(((long)(var16 * var9 - var10 * var15) << 14) / (long)field2906);
            int var38 = var13 * var11 - var10 * var14 << 14;
            int var39 = (int)(((long)(var16 * var14 - var13 * var17) << 3 << 14) / (long)field2906);
            int var40 = (int)(((long)(var17 * var10 - var11 * var16) << 14) / (long)field2906);
            int var41;
            if(var0 <= var1 && var0 <= var2) {
               if(var0 < field2910) {
   ...
   @ObfuscatedName("q")
   static final int method4253(int var0, int var1, int var2, int var3) {
      return var0 * var2 + var3 * var1 >> 16;
   }
   ...
   public static final void method4251(class8 var0) {
      field2895 = var0;
   }

   @ObfuscatedName("az")
   static final int method4270(int var0, int var1, int var2, int var3) {
      return var2 * var1 - var3 * var0 >> 16;
   }

   @ObfuscatedName("w")
   public static final void method4326() {
      field2907 = field2908 / 2;
      field2897 = field2910 / 2;
      field2915 = -field2907;
      field2912 = field2908 - field2907;
      field2911 = -field2897;
      field2913 = field2910 - field2897;
