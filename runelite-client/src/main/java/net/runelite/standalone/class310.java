...
public abstract class class310 {
   ...
   void method5903(int var1, int var2, Buffer var3, int var4) {
   ...
   void method5901(int var1, int var2, Buffer var3) {
      ...
      if(var0 != client.gameState) {
         ...
         if(var0 != 5 && var0 != 10) {
            if(var0 == 20) {
               ...
               class316.leftBackground = null;
               class316.rightBackground = null;
               ...
               if(var2 == null) {
                  if(class258.field3279 != 0) {
                     try {
                        ...
                        var7.writeByte(4);
                        var7.writeByte(class258.field3279);
                        var7.writeShort(0);
